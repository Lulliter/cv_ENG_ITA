...
params:
  cv_code: 
    ...
    value: pol
    input: select
    choices: ["data","pol", "euro"]  
  position:
    label: position
    value: "Economist and Policy Analyst"
    input: select
    choices: ["Public Policy & Data Analysis","Economist and Policy Analyst", "Expert of Public Policy and EU funds planning"]
  aboutme:
      label: Short Bio
      value: "**PROFILE**: I am an economist by training with demonstrated expertise designing and implementing diagnostic tools, advanced analytics and data visualizations applied to economic development. Most of my research revolves around different policies improving universal access to basic infrastructure services (housing, water and sanitation, energy, education and health). \n\n**GOAL**: I am passionate about using data from different sources –including text data, GIS and satellite imagery– to understand and tackle complex public policy issues."
      input: select
...
\textcolor{cyan}{\href{https://scholar.google.com/citations?user=OBYla5gAAAAJ&hl=en&oi=ao)}{[See complete list on \textbf{Google Scholar profile}]}} 
