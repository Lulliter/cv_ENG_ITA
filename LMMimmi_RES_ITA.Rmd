...
params:
  ...
  position:
    label: position
    value: Esperta in Economia dello sviluppo e Sostenibilità
    input: select
    choices: [
    "Esperta in Economia dello sviluppo e Sostenibilità", 
    "Analista di Fondi UE e PNRR", #1
    "Valutazione Politiche Pubbliche ed Europrogettazione", #2
    "Economista -- sviluppo sostenibile", #3
    "Economia e analisi di mercato", #4
    "Policy & Data Analyst", #5
    "Business Intelligence Analyst", #6
    "Data Scientist", #7
    "Economista e Data Journalist" #8 
  ]
  aboutme:
      label: Short Bio
      value: |-
        ****PROFILO**: Economista dello sviluppo con Master in Politiche Pubbliche alla Georgetown University e solida formazione in econometria e statistica. Esperienza professionale di oltre 15 anni presso società di consulenza e banche multilaterali di sviluppo: conduzione di analisi di mercato e studi settoriali, monitoraggio e valutazione di impatto e resilienza per progetti di sviluppo economico.  
        **OBIETTIVO**: Applicare le mie competenze analitiche e di _project management_ nell'ambito della valutazione e implementazione di politiche per lo sviluppo sostenibile in ambito nazionale e/o Europeo.
      input: select
      choices: [
        # pol svil sostenib
