...
params:
  cv_code: 
    ...
    value: pol
    input: select
    choices: ["pol","europrog","data_infra","data_banche"]  
  position:
    label: position
    value: Esperta di Economia e Politiche Pubbliche
    input: select
    choices: ["Esperta di Economia e Politiche Pubbliche","Esperta di Politiche Pubbliche ed Europrogettazione", "Policy & Data Analyst", "Policy & Business Intelligence Analyst"]
  aboutme:
      label: Short Bio
      value: |-
