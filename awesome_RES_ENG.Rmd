...
params:
  cv_code: 
    ...
    value: euro
    input: select
    choices: ["euro","pol","data"]  
  position:
    label: position
    value: "Expert of Public Policy and EU funds planning"
    input: select
    choices: ["Expert of Public Policy and EU funds planning","Economist and Policy Analyst", "Public Policy & Data Analysis"]
  aboutme:
      label: Short Bio
      value: "**PROFILE**: Experienced policy advisor with a strong background in statistics and econometrics applied to economic development. In over 15 years of experience, in Italy and abroad, I have evaluated the feasibility and impact of policies and financial instruments promoting inclusive and sustainable access to infrastructure services (housing, mobility, water and sanitation, energy, education and health). <br><br> **GOAL**: I am currently pursuing opportunities to apply my policy analysis and project management skills towards the implementation and evaluation of national & EU Structural and Investment Funds (PNRR, Next Generation EU, ERDF, ESF, CF, etc)."
      input: select
      choices: ["**PROFILE**: Experienced policy advisor with a strong background in statistics and econometrics applied to economic development. In over 15 years of experience, in Italy and abroad, I have evaluated the feasibility and impact of policies and financial instruments promoting inclusive and sustainable access to infrastructure services (housing, mobility, water and sanitation, energy, education and health). <br><br> **GOAL**: I am currently pursuing opportunities to apply my policy analysis and project management skills towards the implementation and evaluation of national & EU Structural and Investment Funds (PNRR, Next Generation EU, ERDF, ESF, CF, etc).",  
      "**PROFILO**: Economista dello sviluppo con Master in Politiche Pubbliche alla Georgetown University e solida formazione in econometria e statistica. Esperienza professionale di oltre 15 anni per Banche Multilaterali di Sviluppo e fondi fiduciari EU in studi diagnostici e congiunturali, monitoraggio e valutazione di impatto per progetti di sviluppo economico. <br><br> **OBIETTIVI**: Applicare le mie competenze nella valuatazione e implementazione di politiche per lo sviluppo sostenibile in ambito nazionale ed Europeo.",
      "**PROFILO**: I am an economist by training with demonstrated expertise designing and implementing diagnostic tools, advanced analytics and data visualizations applied to economic development. Most of my research revolves around different policies improving universal access to basic infrastructure services (housing, water and sanitation, energy, education and health). <br><br> **GOAL**: I am passionate about using data from different sources –including social media, GIS and satellite imagery– to understand and tackle complex public policy issues. ."]

# aboutme: |-
#   **PROFILE**: Experienced policy advisor with a strong background in statistics and econometrics applied to economic development. In over 15 years of experience, in Italy and abroad, I have evaluated the feasibility and impact of policies and financial instruments promoting inclusive and sustainable access to infrastructure services (housing, mobility, water and sanitation, energy, education and health).  
...
data.frame(
  Skill = c( "(Write and Speak)"), # no"  & " will mess Latex
...
## \faBookOpen[regular] Peer-reviewed Articles and Technical Reports
