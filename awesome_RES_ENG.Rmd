...
params:
  cv_code: 
    ...
    value: pol
    input: select
    choices: ["pol", "euro","data"]  
  position:
    label: position
    value: "Economist and Policy Analyst"
    input: select
    choices: ["Economist and Policy Analyst", "Expert of Public Policy and EU funds planning","Public Policy & Data Analysis"]
  aboutme:
      label: Short Bio
      value: "**PROFILE**: Accomplished policy advisor with a strong background in statistics and econometrics applied to economic development. In over 15 years of experience, in Italy and abroad, I have evaluated the feasibility and impact of policies and financial instruments promoting inclusive and sustainable access to infrastructure services (housing, mobility, water and sanitation, energy, education and health). <br><br> **GOAL**: I am currently pursuing opportunities to apply my policy analysis and project management skills towards the implementation and evaluation of policies for sustainable development within the national & EU context."
      input: select
      choices: ["**PROFILE**: Accomplished policy advisor with a strong background in statistics and econometrics applied to economic development. In over 15 years of experience, in Italy and abroad, I have evaluated the feasibility and impact of policies and financial instruments promoting inclusive and sustainable access to infrastructure services (housing, mobility, water and sanitation, energy, education and health). <br><br> **GOAL**: I am currently pursuing opportunities to apply my policy analysis and project management skills towards the implementation and evaluation of policies for sustainable development within the national & EU context.",  
      "**PROFILE**: Accomplished policy advisor with a strong background in statistics and econometrics applied to economic development. In over 15 years of experience, in Italy and abroad, I have evaluated the feasibility and impact of policies and financial instruments promoting inclusive and sustainable access to infrastructure services (housing, mobility, water and sanitation, energy, education and health). <br><br> **GOAL**: I am currently pursuing opportunities to apply my policy analysis and project management skills towards the implementation and evaluation of national & EU Structural and Investment Funds (PNRR, Next Generation EU, ERDF, ESF, CF, Horizon, etc).",  
