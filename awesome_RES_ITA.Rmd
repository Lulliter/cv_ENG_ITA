...
params:
  ...
  position:
    ...
    input: select
    choices: ["Esperta di Economia e Politiche Pubbliche","Esperta di Politiche Pubbliche ed Europrogettazione", "Policy & Data Analyst"]
  aboutme:
      label: Short Bio
      value: |-
       **PROFILO**: Economista dello sviluppo con Master in Politiche Pubbliche alla Georgetown University e solida formazione in econometria e statistica. Esperienza professionale di oltre 15 anni per Banche Multilaterali di Sviluppo e fondi UE in studi diagnostici e congiunturali, monitoraggio e valutazione di impatto per progetti di sviluppo economico.  
       **OBIETTIVI**: Vorrei applicare le mie competenze analitiche e di _project management_ nell'ambito della valutazione e implementazione di politiche per lo sviluppo sostenibile in ambito nazionale e/o Europeo.
      input: select
      choices: ["**PROFILO**: Economista dello sviluppo con Master in Politiche Pubbliche alla Georgetown University e solida formazione in econometria e statistica. Esperienza professionale di oltre 15 anni per Banche Multilaterali di Sviluppo e fondi UE in studi diagnostici e congiunturali, monitoraggio e valutazione di impatto per progetti di sviluppo economico. <br><br>**OBIETTIVI**: Vorrei applicare le mie competenze analitiche e di _project management_ nell'ambito della valutazione e implementazione di politiche per lo sviluppo sostenibile in ambito nazionale e/o Europeo.",
      "**PROFILO**: Economista con una solida esperienza nell'analisi statistica ed econometrica applicata allo sviluppo economico. In oltre 15 anni di esperienza in Italia e all'estero, ho valutato la fattibilità e l'impatto di politiche e strumenti finanziari finalizzati all'accesso inclusivo e sostenibile ai servizi infrastrutturali (abitazione, mobilità, acqua e servizi igienico-sanitari, energia, istruzione e salute). <br><br>**OBIETTIVI**: Vorrei applicare le mie competenze analitiche e di _project management_ nell'ambito della e valutazione/implementazione dei fondi strutturali e di investimento in ambito nazionale/UE (PNRR, Next Generation EU, FESR, FSE, Fondi di Coesione, Horizon Europe, ecc.).",  
      "**PROFILO**: Economista di formazione con comprovata esperienza nella progettazione e implementazione di strumenti diagnostici, analisi avanzate e visualizzazioni di dati applicati allo sviluppo economico. Ho condotto studi empirici su interventi strumenti finanziari mirati a promuovere l’accesso inclusivo e sostenibile a servizi infrastrutturali di base (acqua e servizi igienico-sanitari, energia, mobilità, istruzione e salute). Per lavoro e per passione, seguo costantemente lo sviluppo di tecniche e strumenti di _data science_. <br><br>**OBIETTIVI**: Sono interessata a opportunità lavorative che mi consentano di ideare e implementare approcci basati sui dati per migliorare l’accesso e la disponibilità di servizi infrastrutturali di alta qualità."]
# aboutme: |-
...
▪<!-- \faIcon{calculator}--> Spiccata attitudine al **pensiero critico e all'analisi dei dati**, perfezionata lungo il percorso professionale  
...
▪<!-- \faIcon{users}--> Capacità di **comunicazione** (scritta e orale) comprovate da pubblicazioni e presentazioni - Inglese e Spagnolo
